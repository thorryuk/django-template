...
ROOT_URLCONF = 'pln.frontend_urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pln.context_processor.media_url',
                'pln.context_processor.frontend_url',
                'pln.context_processor.backend_url'
            ],
        },
    },
]
...
BACKEND_END_URL = 'http://cms-ppa.co.id:8011/'

CELERY_BROKER_URL = 'amqp://rabbitmq:qnJzJ46d1RypmwYq@172.20.0.2:5672//'
CELERY_DEFAULT_QUEUE = 'celery'

DEFAULT_MAIL_FROM = 'no-reply@nippon-express.com'
